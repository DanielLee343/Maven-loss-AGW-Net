...
def attn_wnet(opt,input_size, lossfxn):
    ...
    attn1 = AttnGatingBlock(conv4, g1, 128, '_1')
    up1 = concatenate([Conv2DTranspose(64, (3,3), strides=(2,2), padding='same', activation='relu', kernel_initializer=kinit)(center1), attn1], name='up1_temp')
    up1 = UnetConv2D(up1, 256, is_batchnorm=True, name='up1')
    conv5 = UnetConv2D(up1, 256, is_batchnorm=True, name='conv5')

    g2 = UnetGatingSignal(up1, is_batchnorm=True, name='g2')
    attn2 = AttnGatingBlock(conv3, g2, 64, '_2')
    up2 = concatenate([Conv2DTranspose(64, (3,3), strides=(2,2), padding='same', activation='relu', kernel_initializer=kinit)(up1), attn2], name='up2_temp')
    up2 = UnetConv2D(up2, 128, is_batchnorm=True, name='up2')
    conv6 = UnetConv2D(up2, 128, is_batchnorm=True, name='conv6')

    g3 = UnetGatingSignal(up2, is_batchnorm=True, name='g3')
    attn3 = AttnGatingBlock(conv2, g3, 32, '_3')
    up3 = concatenate([Conv2DTranspose(32, (3,3), strides=(2,2), padding='same', activation='relu', kernel_initializer=kinit)(up2), attn3], name='up3_temp')
    up3 = UnetConv2D(up3, 64, is_batchnorm=True, name='up3')
    conv7 = UnetConv2D(up3, 64, is_batchnorm=True, name='conv7')
    ...
    conv12 = UnetConv2D(up5, 256, is_batchnorm=True, name='conv12')
    conv13 = UnetConv2D(up6, 128, is_batchnorm=True, name='conv13')
    conv14 = UnetConv2D(up7, 64, is_batchnorm=True, name='conv14')
    conv15 = UnetConv2D(up8, 32, is_batchnorm=True, name='conv15')
    
    out12 = Conv2D(1, (1, 1), activation='sigmoid', name='pred1')(conv12)
    out13 = Conv2D(1, (1, 1), activation='sigmoid', name='pred2')(conv13)
    out14 = Conv2D(1, (1, 1), activation='sigmoid', name='pred3')(conv14)
    out15 = Conv2D(1, (1, 1), activation='sigmoid', name='final')(conv15)

    model = Model(inputs=[img_input], outputs=[out12, out13, out14, out15])
